...
public class LinkedListDemo {
	...
	public static void main(String[] args) {
		...
		placesToVisit.add("Aagra");
		placesToVisit.add("Hyderabad");
		placesToVisit.add("Secunderbad");
		placesToVisit.add("Herndon");
		placesToVisit.add("Reston");
		placesToVisit.add("VA");
		placesToVisit.add("GA");
	...
	private static void printMenu() {
		...
		System.out.println("0 -to quit\n"+
		                   ...
		                   "3 - print menu options");// TODO Auto-generated method stub
